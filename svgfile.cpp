...
void Svgfile::addEllipse(double x, double y, double ex, double ey, double ep, std::string colorc)
{
    m_ostrm << "<ellipse "
            << attrib("cx", x)
            << attrib("cy", y)
...
void Svgfile::addTriangle1(double x1, double y1, double x2, double y2,
